<?php /*a:3:{s:68:"D:\wamp64\www\tpblog\application\frontend\view\article\user_info.tpl";i:1535185195;s:62:"D:\wamp64\www\tpblog\application\frontend\view\common\base.tpl";i:1535013977;s:77:"D:\wamp64\www\tpblog\application\frontend\view\common\widget\article-item.tpl";i:1535185195;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="col-md-3">
      <div class="text-center">
        <section class="user-msg">
          <div class="header">
            <?php if($user->avatar): ?>
              <img src="/uploads/<?php echo htmlentities($user->avatar); ?>" alt="" style="width:120px;height:120px;" class="img-circle img-responsive center-block">
            <?php else: ?>
              <img src="/static/images/header.jpg" alt="" class="img-circle img-responsive center-block">
            <?php endif; ?>
          </div>
          <h5><?php echo htmlentities($user->nickname); ?></h5>
          <p></p>
        </section>
        <div class="list-group">
          博文数量 <?php echo htmlentities($articles->total()); ?>
        </div>
      </div>
      
      <div class="category-list" data-url="<?php echo url('ajax_category_list','uid='.$user->id); ?>"></div>

    </div>
    <div class="col-md-9">
      <ol class="breadcrumb">
        <li><a href="<?php echo url('homepage'); ?>">首页</a></li>
        <li class="active"><?php echo htmlentities($user->nickname); ?></li>
      </ol>
